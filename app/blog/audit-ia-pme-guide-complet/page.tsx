    ...
    <>
      ...
      <main className="min-h-screen bg-background">
        ...
        <section className="py-8 bg-muted/50 border-b border-border"><div className="container mx-auto px-4"><div className="grid grid-cols-2 md:grid-cols-4 gap-6 max-w-4xl mx-auto text-center">
          <div><p className="text-2xl md:text-3xl font-bold text-orange-600">2-3 jours</p><p className="text-sm text-muted-foreground mt-1">Audit IA Express</p></div>
          <div><p className="text-2xl md:text-3xl font-bold text-orange-600">3-5</p><p className="text-sm text-muted-foreground mt-1">Quick wins identifiés</p></div>
        ...
        <section className="py-12"><div className="container mx-auto px-4"><div className="max-w-7xl mx-auto"><div className="grid lg:grid-cols-[1fr_280px] gap-12 xl:gap-16">
          <article className="min-w-0"><div className="max-w-[720px]">
            ...
            <ul className="space-y-3 my-6">
              <li className="flex items-start gap-3"><CheckCircle2 className="w-5 h-5 text-orange-600 mt-0.5 flex-shrink-0" /><p className="text-muted-foreground"><strong className="text-foreground">Cartographie des processus</strong> à fort potentiel d&apos;automatisation</p></li>
              <li className="flex items-start gap-3"><CheckCircle2 className="w-5 h-5 text-orange-600 mt-0.5 flex-shrink-0" /><p className="text-muted-foreground"><strong className="text-foreground">3 à 5 cas d&apos;usage</strong> les plus rentables identifiés</p></li>
              <li className="flex items-start gap-3"><CheckCircle2 className="w-5 h-5 text-orange-600 mt-0.5 flex-shrink-0" /><p className="text-muted-foreground"><strong className="text-foreground">ROI projeté</strong> pour chaque cas d&apos;usage, en euros</p></li>
              <li className="flex items-start gap-3"><CheckCircle2 className="w-5 h-5 text-orange-600 mt-0.5 flex-shrink-0" /><p className="text-muted-foreground"><strong className="text-foreground">Roadmap prioritisée</strong> : quick win d&apos;abord, le reste ensuite</p></li>
            </ul>
            ...
            <div className="overflow-x-auto -mx-4 px-4 my-8"><table className="w-full text-sm border-collapse min-w-[600px]"><thead><tr className="border-b-2 border-orange-500"><th className="text-left py-3 px-4 font-semibold text-foreground">Format</th><th className="text-left py-3 px-4 font-semibold text-foreground">Durée</th><th className="text-left py-3 px-4 font-semibold text-foreground">Coût</th><th className="text-left py-3 px-4 font-semibold text-foreground">Pour qui</th></tr></thead><tbody className="divide-y divide-border">
              <tr className="hover:bg-muted/50"><td className="py-3 px-4 text-foreground font-medium">Audit IA Express</td><td className="py-3 px-4 text-muted-foreground">2-3 jours</td><td className="py-3 px-4 text-orange-600 font-semibold">Gratuit à 2 000 euros</td><td className="py-3 px-4 text-muted-foreground">PME qui veut aller vite</td></tr>
              <tr className="hover:bg-muted/50"><td className="py-3 px-4 text-foreground font-medium">Smart Analyse (complet)</td><td className="py-3 px-4 text-muted-foreground">2-4 semaines</td><td className="py-3 px-4 text-orange-600 font-semibold">5 000 - 15 000 euros</td><td className="py-3 px-4 text-muted-foreground">PME/ETI périmètre large</td></tr>
              <tr className="hover:bg-muted/50"><td className="py-3 px-4 text-foreground font-medium">Diag Data IA BPI</td><td className="py-3 px-4 text-muted-foreground">6-10 jours</td><td className="py-3 px-4 text-orange-600 font-semibold">10-15K (25% pris en charge)</td><td className="py-3 px-4 text-muted-foreground">PME éligibles BPI</td></tr>
            ...
            <div className="space-y-4 my-6">
              <div className="flex items-start gap-3"><CheckCircle2 className="w-5 h-5 text-orange-600 mt-0.5 flex-shrink-0" /><p className="text-muted-foreground"><strong className="text-foreground">Audit IA Express :</strong> 2-3 jours, 3 quick wins, ROI projeté. Gratuit si le potentiel le justifie.</p></div>
              <div className="flex items-start gap-3"><CheckCircle2 className="w-5 h-5 text-orange-600 mt-0.5 flex-shrink-0" /><p className="text-muted-foreground"><Link href="/services/audit" className="text-orange-600 hover:text-orange-700 underline underline-offset-4 decoration-orange-500/30 font-semibold">Smart Analyse</Link> : audit complet + roadmap 6-12 mois. 5 000-15 000 euros en forfait.</p></div>
            </div>
            <p className="text-base leading-[1.7] text-muted-foreground mb-4">3 principes : <strong className="text-foreground">ROI d&apos;abord</strong>, <strong className="text-foreground">forfait</strong> (pas TJM), <strong className="text-foreground">go/no-go</strong> honnête. L&apos;expérience derrière : <Link href="/a-propos" className="text-orange-600 hover:text-orange-700 underline underline-offset-4 decoration-orange-500/30">Laurent Bouzon</Link>, 9 ans de terrain chez Lyko, co-fondation SymbiozAI, board French Tech Lyon.</p>
            ...
            <div className="mt-12 p-8 bg-muted/50 rounded-2xl border border-border"><div className="flex flex-col sm:flex-row items-start gap-6"><div className="w-20 h-20 bg-gradient-to-br from-orange-400 to-orange-600 rounded-full flex items-center justify-center text-white text-3xl font-bold flex-shrink-0">L</div><div><p className="text-sm font-medium text-orange-600 uppercase tracking-wide mb-1">À propos de l&apos;auteur</p><h3 className="text-xl font-bold text-foreground mb-2">Laurent Bouzon</h3><p className="text-muted-foreground leading-relaxed">Fondateur & CEO de Smart Impulsion. 9 ans chez Lyko, co-fondateur SymbiozAI, board French Tech Lyon. Expert en audit IA et transformation des PME françaises.</p></div></div></div>
          </div></article>
