    ...
    <>
      ...
      <main className="min-h-screen bg-background">
        ...
        <section className="py-8 bg-muted/50 border-b border-border"><div className="container mx-auto px-4"><div className="grid grid-cols-2 md:grid-cols-4 gap-6 max-w-4xl mx-auto text-center">
          ...
          <div><p className="text-2xl md:text-3xl font-bold text-orange-500">+18%</p><p className="text-sm text-muted-foreground mt-1">Performance commerciale</p></div>
          <div><p className="text-2xl md:text-3xl font-bold text-orange-500">24%</p><p className="text-sm text-muted-foreground mt-1">ROI moyen</p></div>
        ...
        <section className="py-12"><div className="container mx-auto px-4"><div className="max-w-7xl mx-auto"><div className="grid lg:grid-cols-[1fr_280px] gap-12 xl:gap-16">
          <article className="min-w-0"><div className="max-w-[720px]">
            ...
            <div className="space-y-8 my-8">
              {[
                { step: 1, title: "Identifier le processus cible", content: <><p className="text-base leading-[1.7] text-muted-foreground">Quel processus coûte le plus cher en temps humain ? Critères de sélection : <strong className="text-foreground">volume</strong> (combien de fois par semaine ?), <strong className="text-foreground">répétitivité</strong> (les étapes sont-elles toujours les mêmes ?), <strong className="text-foreground">coût humain</strong> (combien de personnes, combien de temps ?), <strong className="text-foreground">impact business</strong> (que se passe-t-il si ce processus est mal fait ?).</p><p className="text-base leading-[1.7] text-muted-foreground mt-2">Un <Link href="/blog/audit-ia-pme-guide-complet" className="text-orange-500 hover:text-orange-600 underline underline-offset-4 decoration-orange-500/30">audit IA</Link> bien mené identifie ce processus en quelques heures.</p></> },
            ...
            <div className="overflow-x-auto -mx-4 px-4 my-8">
              <table className="w-full text-sm border-collapse min-w-[600px]">
                ...
                <tbody className="divide-y divide-border">
                  <tr className="hover:bg-muted/50"><td className="py-3 px-4 text-foreground font-medium">Prospection outbound</td><td className="py-3 px-4 text-orange-500 font-semibold">x3 à x4</td><td className="py-3 px-4 text-muted-foreground">+12% de RDV</td><td className="py-3 px-4 text-muted-foreground">20-35%</td></tr>
                  <tr className="hover:bg-muted/50"><td className="py-3 px-4 text-foreground font-medium">Suivi CRM</td><td className="py-3 px-4 text-orange-500 font-semibold">-40% saisie</td><td className="py-3 px-4 text-muted-foreground">Zéro doublon</td><td className="py-3 px-4 text-muted-foreground">15-25%</td></tr>
                  <tr className="hover:bg-muted/50"><td className="py-3 px-4 text-foreground font-medium">Production contenu</td><td className="py-3 px-4 text-orange-500 font-semibold">x5</td><td className="py-3 px-4 text-muted-foreground">Volume x5</td><td className="py-3 px-4 text-muted-foreground">20-30%</td></tr>
                  <tr className="hover:bg-muted/50"><td className="py-3 px-4 text-foreground font-medium">Traitement commandes</td><td className="py-3 px-4 text-orange-500 font-semibold">-12h/sem</td><td className="py-3 px-4 text-muted-foreground">-70% erreurs</td><td className="py-3 px-4 text-muted-foreground">25-40%</td></tr>
                  <tr className="hover:bg-muted/50"><td className="py-3 px-4 text-foreground font-medium">Gestion réclamations</td><td className="py-3 px-4 text-orange-500 font-semibold">Zéro perte</td><td className="py-3 px-4 text-muted-foreground">Délais /2</td><td className="py-3 px-4 text-muted-foreground">20-30%</td></tr>
                </tbody>
              </table>
            </div>
            <p className="text-sm text-muted-foreground mb-4">Un <Link href="/blog/ia-pour-pme-guide" className="text-orange-500 hover:text-orange-600 underline underline-offset-4 decoration-orange-500/30">guide complet sur l&apos;IA pour PME</Link> détaille les cas d&apos;usage secteur par secteur.</p>
            ...
            <div className="space-y-4 my-6">
              <div className="flex items-start gap-3"><CheckCircle2 className="w-5 h-5 text-orange-500 mt-0.5 flex-shrink-0" /><p className="text-muted-foreground"><strong className="text-foreground">Avant :</strong> ROI projeté avec méthodologie transparente. On prend 50% du potentiel théorique.</p></div>
              <div className="flex items-start gap-3"><CheckCircle2 className="w-5 h-5 text-orange-500 mt-0.5 flex-shrink-0" /><p className="text-muted-foreground"><strong className="text-foreground">Pendant :</strong> Mesure des métriques toutes les 2 semaines.</p></div>
              <div className="flex items-start gap-3"><CheckCircle2 className="w-5 h-5 text-orange-500 mt-0.5 flex-shrink-0" /><p className="text-muted-foreground"><strong className="text-foreground">Après :</strong> Vérification du ROI réel à M+2/M+3.</p></div>
            </div>
            ...
            <p className="text-base leading-[1.7] text-muted-foreground mb-4">L&apos;<Link href="/services/audit" className="text-orange-500 hover:text-orange-600 underline underline-offset-4 decoration-orange-500/30">Audit IA Express</Link> identifie les 3 quick wins les plus rentables en 2-3 jours. Coût : gratuit à 2 000 euros. En savoir plus sur <Link href="/a-propos" className="text-orange-500 hover:text-orange-600 underline underline-offset-4 decoration-orange-500/30">notre approche</Link>.</p>
            ...
            <Accordion type="single" collapsible className="my-8">
              ...
              <AccordionItem value="faq-5" className="border-border"><AccordionTrigger className="text-left text-foreground font-semibold hover:text-orange-500 hover:no-underline py-5">Quel budget minimum prévoir ?</AccordionTrigger><AccordionContent className="text-muted-foreground leading-relaxed pb-5">5 000 à 15 000 euros tout compris. L&apos;Audit IA Express : 0 à 2 000 euros. À mettre en regard des gains : des dizaines de milliers d&apos;euros d&apos;économie annuelle. Consultez notre <Link href="/faq" className="text-orange-500 underline">FAQ complète</Link>.</AccordionContent></AccordionItem>
            </Accordion>
