          ...
          {results.map((result, index) => (
            ...
            >
              <div className="flex items-center justify-center mb-4">
                <result.icon className={`h-6 w-6 mr-2 ${result.isNegative ? "text-green-500" : "text-orange-700"}`} />
                <span className={`text-4xl font-bold ${result.isNegative ? "text-green-500" : "text-orange-700"}`}>
                  {result.metric}
                </span>
              </div>
