    ...
    >
      <div className="relative font-bold flex items-center">
        ...
        <div className="relative">
          <span
            className={`${textSize} text-orange-700 ml-1.5 transition-all duration-300 ${isHovered ? "transform translate-y-0.5" : ""}`}
          >
            Impulsion
          </span>
          <ArrowUpRight
            className={`${iconSize} text-orange-700 absolute -top-1 -right-3 transition-all duration-300 ${
